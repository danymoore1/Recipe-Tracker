...
Public Class DynamicMenu
    ...
    Private mItem As New ToolStripMenuItem()
    ...
    Public Function LoadDynamicMenu()
        ...
        For Each objNode In objXML.FirstChild.ChildNodes
            ...
            GenerateMenusFromXML(objNode, mainMenuStrip.Items(mainMenuStrip.Items.Count - 1))
        Next
    ...
    ''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
    Private Sub GenerateMenusFromXML(ByVal objNode As Xml.XmlNode, ByVal mItm As ToolStripMenuItem)
        ...
        For Each objNod In objNode.ChildNodes
            ...
            GenerateMenusFromXML(objNod, mItm.DropDownItems(mItm.DropDownItems.Count - 1))
        Next
        'assign the generated mainMenuStrip object to objMenu - public object
        'which is to be used in the Main Form
        objMenu = mainMenuStrip
    End Sub
    ...
    ''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
    Private Sub FindEventsByName(ByVal sender As Object,
     ByVal receiver As Object, ByVal bind As Boolean,
     ByVal handlerPrefix As String, ByVal handlerSufix As String)
        ...
        For Each E In SenderEvents
            Method = ReceiverType.GetMethod(
              handlerPrefix & E.Name & handlerSufix,
